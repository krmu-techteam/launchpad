...
const Footer = () => {
  return (
    <>
      ...
      <ScrollToTop />
      <SocialIcons />
      <div className="fixed bottom-[6%] left -5 z-40 w-[140px] h-[140px] md:w-[150px] md:h-[150px] flex items-center justify-center text-center p-5 font-semibold">
        <Image src="/images/star.png" fill alt="" className="rotate-star" />
        <p className="text-xs text-black leading-5 z-50 mb-0 font-semibold sm:leading-snug font-poppins">
